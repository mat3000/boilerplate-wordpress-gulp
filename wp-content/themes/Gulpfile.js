...
gulp.task('php', () => {
	...
	if(process.env.NODE_ENV){
		...
		let devtools  = '';
			devtools += '<script type="text/javascript">(function(){var n=document.createElement("div");n.innerHTML+="<div id=\\"dev-mode-29384\\" style=\\"position:fixed;top:0;left:0;width:100%;height:5px;background:red;transition:all 1s linear;\\"></div>";document.body.appendChild(n);setTimeout(function(){document.getElementById("dev-mode-29384").style.opacity=0;},1000);})();</script>';
			// devtools += '<script type="text/javascript">(function(){window.addEventListener("load",function(){var n=document.createElement("div");n.innerHTML+="<div id=\\"dev-mode-29384\\" style=\\"position:fixed;top:0;left:0;width:100%;height:1px;background:red;transition:opacity 1s linear;\\"></div>";document.body.appendChild(n);setTimeout(function(){document.getElementById("dev-mode-29384").style.opacity=0;},1000)},false);})();</script>';
